...
public:
    ...
    ///
    bool readDim2File(QString filename = "", quint32 firstLine = 1, quint32 lastLine = 999999, quint32 step = 1);
...
private:
    ...
    //QList<NavInfo> _navInfoList;
    //QStringList _imagesNamesList;

    static QRegExp _lineRegExp;
    bool _fileIsValid;
    bool addInfo(QString datasLine);
};
