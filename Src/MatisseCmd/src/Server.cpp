...
DummyServer2::DummyServer2(QObject *parent) :
    QObject(parent),
...
QList<Processor*> const DummyServer2::getAvailableProcessors() {
    return _processors.values();
}

QList<ImageProvider*> const DummyServer2::getAvailableImageProviders() {
    return _imageProviders.values();
}

const QList<RasterProvider *> DummyServer2::getAvailableRasterProviders()
{
    return _rasterProviders.values();
}

void DummyServer2::addParametersForImageProvider(QString name)
{
...
void DummyServer2::addParametersForProcessor(QString name)
{
...
void DummyServer2::addParametersForRasterProvider(QString name)
{
...
bool DummyServer2::removeModuleAndExpectedParameters(QString name)
{
...
MatisseParameters* DummyServer2::buildMatisseParameters(JobDefinition &job) {
...
void DummyServer2::setMessageStr(QString messageStr, bool error)
{
...
void DummyServer2::slot_currentJobProcessed()
{
    if(_currentJob == NULL)
        return;
...
bool DummyServer2::buildJobTask(AssemblyDefinition &assembly, JobDefinition &jobDefinition, MatisseParameters *matisseParameters)
{
    ...
    _currentJob = new DummyJobTask2(imageProvider, processorList, rasterProvider, jobDefinition, matisseParameters);
...
bool DummyServer2::processJob(JobDefinition &jobDefinition)
{
    setMessageStr();
...
bool DummyServer2::isProcessingJob()
{
    return _currentJob!=NULL;
}

bool DummyServer2::stopJob(bool cancel)
{
    if (_currentJob) {
...
bool DummyServer2::errorFlag()
{
    return _errorFlag;
}

QString DummyServer2::messageStr()
{
    return _messageStr;
}
...
DummyJobTask2::DummyJobTask2(ImageProvider* imageProvider, QList<Processor*> processors, RasterProvider* rasterProvider,
...
DummyJobTask2::~DummyJobTask2()
{
    delete _matParameters;
}

void DummyJobTask2::stop(bool cancel)
{
    _isCancelled = cancel;
...
bool DummyJobTask2::isCancelled() const
{
    return _isCancelled;
}

void DummyJobTask2::slot_showImageOnMainView(Image *image)
{
    emit signal_jobShowImageOnMainView(_jobDefinition.name(), image);
}

void DummyJobTask2::slot_userInformation(QString userText)
{
    emit signal_userInformation(userText);
}

void DummyJobTask2::slot_processCompletion(quint8 percentComplete)
{
    emit signal_processCompletion(percentComplete);
}

void DummyJobTask2::slot_fatalError()
{
    _isCancelled = true;
    stop(true);
    _isCancelled = true;
...
void DummyJobTask2::setMainGui(JobLauncher *mainGui)
{
    _mainGui = mainGui;
}

QStringList DummyJobTask2::resultFileNames() const
{
    return _resultFileNames;
}

JobDefinition &DummyJobTask2::jobDefinition() const
{
    return _jobDefinition;
}


bool DummyServer2::loadParametersDictionnary()
{
...
void DummyServer2::setProcessDataManager(ProcessDataManager *processDataManager)
{
    _processDataManager = processDataManager;
}

void DummyServer2::setSystemDataManager(SystemDataManager *systemDataManager)
{
    _systemDataManager = systemDataManager;
}


void DummyServer2::setMainGui(JobLauncher *mainGui_p)
{
    _mainGui = mainGui_p;
}
