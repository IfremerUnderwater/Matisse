...
/*
 * Header file generated by MatisseDictionnaryValidator tool on 25/07/2024 13:51:32
...
public:
	...
	void declareLabels()
	{
		...
		_paramLabelKeys.insert("force_gpu_usage", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Force gpu usage"));
		_paramLabelKeys.insert("quality_vs_speed", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Quality vs speed"));
		...
		_paramLabelKeys.insert("disjoint_drawing", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Disjoint mosaicking"));
		_paramLabelKeys.insert("single_image_output", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Single image output type"));
		...
		_paramLabelKeys.insert("use_gpu_with_opencl", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Activate the use of GPU acceleration with OpenCL"));
		...
		_paramLabelKeys.insert("guided_matching", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Guided Matching based on 2-views Geometry"));
		...
		_paramLabelKeys.insert("camera_list", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Camera list"));
		...
		_paramLabelKeys.insert("remote_dataset_dir", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Data path"));
		_paramLabelKeys.insert("remote_navFile", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Navigation file"));
		_paramLabelKeys.insert("remote_output_dir", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Output path"));
		_paramLabelKeys.insert("remote_output_filename", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Output name prefix"));
		_paramLabelKeys.insert("remote_dataset_parent_dir", QT_TRANSLATE_NOOP("MatisseTools::MatisseDictionnaryLabels", "Data parent path"));
