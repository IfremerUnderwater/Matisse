...
RemoteServerSetting MatisseRemoteServerSettings::datasetsDir() const {
    return m_datasets_dir;
}

void MatisseRemoteServerSettings::setDatasetsDir(const RemoteServerSetting& _datasets_dir) {
    m_datasets_dir = _datasets_dir;
}
...
QString MatisseRemoteServerSettings::datasetsPath() {
    QString datasets_path = datasetsDir().path();
    return datasets_path;
}

QString MatisseRemoteServerSettings::datasetsPathBound() { 
    QString datasets_path_bound = "~/" + datasetsDir().alias();
