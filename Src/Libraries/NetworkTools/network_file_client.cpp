...
void NetworkFileClient::connectAction(NetworkAction *_action)
{
    ...
    connect(_action, SIGNAL(si_upload(QString, QString, bool, bool)), SLOT(sl_upload(QString, QString, bool, bool)));
...
void NetworkFileClient::disconnectAction(NetworkAction *_action)
{
    ...
    disconnect(_action, SIGNAL(si_upload(QString, QString, bool, bool)), this, SLOT(sl_upload(QString, QString, bool, bool)));
