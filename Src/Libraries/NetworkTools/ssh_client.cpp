...
//    emit si_commandOutputReceived(m_current_action, output_stream);
...
//void SshClient::sl_onShellOutputReceived(QByteArray _output) {
//}
...
//    emit si_commandlErrorReceived(m_current_action, error_stream);
//}

//void SshClient::sl_onShellErrorReceived(QByteArray _output) {
//}


//void SshClient::sl_onShellClosed() {
...
//void SshClient::doInitBeforeAction() {
